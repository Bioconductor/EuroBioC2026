...
::: {.workshop-hero-text}
### 🧬 Microbiome Workshop (June 1–2)

**Orchestrating Microbiome Analysis with Bioconductor**

Hands-on Bioconductor Carpentries training covering microbiome workflows,
diversity analysis, differential abundance, and multi-omics integration.

[Learn more →](/pages/pre-conference.html#orchestrating-microbiome-analysis-with-bioconductor){.btn .btn-success .rounded-pill}
:::
