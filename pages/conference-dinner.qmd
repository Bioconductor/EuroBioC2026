...
- 22:15–23:00 – Men’s sauna
- 23:00–23:45 – Inclusive mixed sauna (open to all genders)
...
Buses are arranged for all registered participants. They depart at **18:00**
from near the conference venue, and the journey takes approximately 20 minutes.
...
source(file.path("..", "R", "create_a_map.R"))
create_route_map(file.path("..", "data", "to_dinner.csv"))
```
...
depart from the dinner venue at **00:00**, taking you back to the
**conference venue**. The return bus will stop at the
...
Based on the current timetable, the available local bus departures are at
21:19, 22:19, and 23:19. Please allow a few extra minutes to walk to the stop.
You can check the exact departure times via [Föli's website](https://reittiopas.foli.fi/reitti/Selected%20location%3A%3A60.439819281069006%2C22.20349788665772/Kauppatori%2C%20Kauppatori%20VI%2C%20Turku%3A%3A60.451693%2C22.26669?locale=en&setTime=true&time=1780509600){target="_blank"}.
