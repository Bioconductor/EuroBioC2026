...
places <- data.frame(
    ...
    lat = c(60.449245, 60.450278, 60.456560, 60.456720),
    lng = c(22.293052, 22.296944, 22.260760, 22.266810)
) |>
    mutate(is_venue = grepl("venue", name, ignore.case = TRUE))

leaflet(places) |>
    addProviderTiles("OpenStreetMap.Mapnik") |>
    # Other places (secondary, but clearly visible)
    addCircleMarkers(
        data = filter(places, !is_venue),
        ~lng, ~lat,
        radius = 7,
        color = "#4a5568",
        fillColor = "#4a5568",
    ...
    addLabelOnlyMarkers(
        ...
        labelOptions = labelOptions(
            ...
            style = list(
                ...
                "padding" = "5px 7px",
                "border-radius" = "6px",
                "box-shadow" = "0 0 6px rgba(43,123,255,0.5)"
            )
        )
    ) |>
    fitBounds(
