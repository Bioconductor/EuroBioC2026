...
This is the outside of the BioCity building.

![](../images/venue/biocity1.jpg){width="70%"}

Please enter through the main entrance shown below.

![](../images/venue/biocity2.jpg){width="70%"}

After entering the building, walk straight ahead for approximately 20 meters.
You will find the registration and information desk there on the left, where
conference staff will assist you further.

![](../images/venue/biocity.gif)

::: {.callout-note title="Practical information"}

- **Free Wi-Fi** is available throughout the venue.
- **Power outlets** are available (European Type C plugs).
- **Time zone:** UTC+3 (Eastern European Summer Time, EEST).
- **Discussion channel:** Join the [Bioconductor Zulip](https://chat.bioconductor.org){target="_blank"} (#eurobioc2026-turku-conference)
:::

::: {.callout-note title="Weather forecast"}

<iframe
  src="https://en.ilmatieteenlaitos.fi/local-weather/turku"
  width="100%"
  height="700"
  style="border:0;">
</iframe>
...
::: callout-tip
All participants get public transportation pass which you can use 3&mdash;5 of
June to travel with public transportation for free. The pass is printed in your
