...
There are two possible designs: one based on the musical note from the Bioconductor logo, and another using an hexagonal shape. These were created by [Kevin Rue-Albrecht](https://kevinrue.github.io/) with input from the [EuroBioC2026 organising committee](organizers.html).

## Preview Hexwall
:::: {.columns}

::: {.column width="49%"}
![](../images/hexwall/biochexwall-270-stickers-273-hex.png){fig-alt="Layout of the hexwall using the musical note design" fig-align="center" width=100% }
...
::: {.column width="49%"}
![](../images/hexwall/hexwall-270-stickers-341-hex.png){fig-alt="Layout of the hexwall using a hexagonal design" fig-align="center" width=100% }
...
- **Submission deadline**: <span class="deadline">Thursday, May 21, 2026</span>
